...
public class roughClass2 {
	...
	public Object[][] windowResolution() {
		...
		return new Object[][] {  { 1920, 1080 }//, { 1280, 720 }, { 1536, 864 }, { 1680, 1050 }, { 1920, 1200 }, { 1440, 900 }, { 1366, 768 }, { 2560, 1440 }
		};
	}
	...
	public static void initilizeDriver(int w, int h) throws InterruptedException {
		if (driver == null) {
			...
			driver.get("https://www.slideteam.net/professional-powerpoint-templates?p=38");
			WebElement element = driver.findElement(By.xpath("//img[@src = 'https://www.slideteam.net/media/catalog/product/cache/330x186/t/i/timeline_ppt_summary_layouts_Slide01.jpg']"));
			...
			// "-" + hight);
               ...
               System.out.println(classname.getX()  + "= x");
               System.out.println(classname.getY()+ "= y");
			float h1= element.getSize().getHeight();
			System.out.println(h1);
			float w2= element.getSize().getWidth();
			 ...
			 * popularPPts = wait
			 * .until(ExpectedConditions.elementToBeClickable(By.xpath(OR.getProperty(
			 * "PopularPPts")))); popularPPts.click();
			 * 
			 * Thread.sleep(3000);
			 * 
			 * WebElement listofImages = driver.findElement( By.
			 * xpath("//div[@class = 'products wrapper grid products-grid']//ol/li/div/a/img[@src]"
			 * )); float width = listofImages.getSize().getWidth();
			 * 
			 * System.out.println(width);
			 * 
			 * float hight = listofImages.getSize().getHeight();
			 * System.out.println(listofImages.getAttribute("title") + " -" + width + "-" +
			 * hight); float roundedValue = width / hight; System.out.println((roundedValue)
			 * + "roundedValue");
			 * 
			 * DecimalFormat df = new DecimalFormat("#.##");
			 * df.setRoundingMode(RoundingMode.DOWN);
			 * System.out.println(df.format(roundedValue));
			 * assertTrue(df.format(roundedValue).equals("1.38") ||
			 ...
			 * // assertTrue(value.equals(actualValue) || value.equals(actualValue1), "ima
