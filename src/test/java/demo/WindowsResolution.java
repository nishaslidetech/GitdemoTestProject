...
public class WindowsResolution extends BaseClass{
	/*
	 * public static WebDriver driver; public static JavascriptExecutor js; public
	 * static FileInputStream fis; public static WebDriverWait wait; static Double
	 * actualValue = 1.775; static Double actualValue1 = 1.775;
	 * 
	 * @DataProvider public Object[][] windowResolution() {
	 * 
	 * return new Object[][] { { 1920, 1080 }, { 1280, 720 }, { 1536, 864 }, { 1440,
	 * 900 }, { 1366, 768 }, { 2560, 1440 }, { 1680, 1050 }, { 1920, 1200 } }; }
	 * 
	 * @Test(dataProvider = "windowResolution") public static void
	 * initilizeDriver(int w, int h) throws InterruptedException { if (driver ==
	 * null) { WebDriverManager.chromedriver().setup(); ChromeDriver driver = new
	 * ChromeDriver();
	 * 
	 * driver.manage().window().setSize(new Dimension(w, h));
	 * //driver.manage().window().maximize(); js = (JavascriptExecutor) driver; wait
	 ...
	 * popularPPts = wait
	 * .until(ExpectedConditions.elementToBeClickable(By.xpath(OR.getProperty(
	 * "PopularPPts")))); popularPPts.click(); Thread.sleep(3000);
	 ...
	 * By.xpath(OR.getProperty("EmarsysImages")));
	 ...
	 * assertTrue(value.equals(actualValue) || value.equals(actualValue1), "image is
	 ...
	 * 
	 * WebElement kpiDashooard = wait.until(
	 * ExpectedConditions.elementToBeClickable(By.xpath(OR.getProperty(
	 ...
	 * BaseClass.checkResolutionSliPages(driver);
	 * 
	 * WebElement businessproposals = wait.until(
	 * ExpectedConditions.elementToBeClickable(By.xpath(OR.getProperty(
	 ...
	 * BaseClass.checkResolutionSliPages(driver);
	 * 
	 * WebElement digitalMarketing = wait.until(
	 * ExpectedConditions.elementToBeClickable(By.xpath(OR.getProperty(
